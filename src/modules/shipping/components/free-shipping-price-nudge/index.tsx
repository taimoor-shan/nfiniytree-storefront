    ...
    <div className="bg-surface-soft p-2 rounded-lg border">
      <div className="space-y-1.5">
        ...
        <div className="flex justify-between gap-1">
          <div
            className={clx(
              "bg-gradient-to-r from-hairline-strong to-muted h-1 rounded-full max-w-full duration-500 ease-in-out",
              {
          ...
          ></div>
          <div className="bg-hairline-strong h-1 rounded-full w-fit flex-grow"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="btn-icon-circular-dark"
      ...
      <div className="w-[400px] bg-surface-dark text-on-dark p-6 rounded-lg ">
        <div className="pb-4">
          <div className="space-y-3">
            <div className="flex justify-between text-[15px] text-on-dark-soft">
              <div>
                {price.target_reached ? (
                  <div className="flex items-center gap-1.5">
                    <CheckCircleSolid className="text-success inline-block" />{" "}
            ...
            <div className="flex justify-between gap-1">
              <div
                className={clx(
                  "bg-gradient-to-r from-hairline-strong to-muted h-1.5 rounded-full max-w-full duration-500 ease-in-out",
                  {
                    "from-green-400 to-green-500": price.target_reached,
                  }
                )}
