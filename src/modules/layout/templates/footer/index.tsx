        ...
        <div className="lg:mt-0 lg:col-span-4 lg:row-span-1">
          ...
          <NewsletterForm />
           <ul className="flex space-x-6 items-center mt-5">
            ...
            <li>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label={dict["footer.instagram"]}>
            ...
            <li>
              <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label={dict["footer.tiktok"]}>
            ...
            <li>
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:opacity-75 transition-opacity" aria-label={dict["footer.twitter"]}>
