...
const EditAddress: React.FC<EditAddressProps> = ({
  ...
  return (
    <>
      <div
        className={clx(
          "border rounded-md p-5 min-h-[220px] h-full w-full flex flex-col justify-between transition-colors",
          {
      ...
      >
        <div className="flex flex-col">
          ...
          {address.company && (
            <Text
              className="txt-compact-small text-ink"
      ...
      <Modal isOpen={state} close={close} data-testid="edit-address-modal">
        <Modal.Title>
          <Heading className="mb-2">{t("addresses.editAddress")}</Heading>
        </Modal.Title>
